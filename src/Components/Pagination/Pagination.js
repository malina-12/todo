...
const Pagination = ({
  ...
  return (
    <div className="pages">
      <button type="button" onClick={switchToFirstPage}>
        <img src={firstPage} alt="first page" />
      </button>

      <button type="button" onClick={switchToPrevPage}>
        <img src={prevPage} alt="previous page" />
      </button>

      <span className="pages__current">{currentPage}</span>

      <button type="button" onClick={switchToNextPage}>
        <img src={nextPage} alt="next page" />
      </button>

      <button type="button" onClick={switchToLastPage}>
